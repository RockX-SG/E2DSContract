...
// VerifySigner is a free data retrieval call binding the contract method 0x4f567307.
//
// Solidity: function verifySigner(address claimaddr, address withdrawaddr, bytes[] pubkeys, bytes[] signatures, bytes paramsSig) view returns(bool)
func (_StakingContract *StakingContractCaller) VerifySigner(opts *bind.CallOpts, claimaddr common.Address, withdrawaddr common.Address, pubkeys [][]byte, signatures [][]byte, paramsSig []byte) (bool, error) {
	var out []interface{}
	err := _StakingContract.contract.Call(opts, &out, "verifySigner", claimaddr, withdrawaddr, pubkeys, signatures, paramsSig)
...
//
// Solidity: function verifySigner(address claimaddr, address withdrawaddr, bytes[] pubkeys, bytes[] signatures, bytes paramsSig) view returns(bool)
func (_StakingContract *StakingContractSession) VerifySigner(claimaddr common.Address, withdrawaddr common.Address, pubkeys [][]byte, signatures [][]byte, paramsSig []byte) (bool, error) {
	return _StakingContract.Contract.VerifySigner(&_StakingContract.CallOpts, claimaddr, withdrawaddr, pubkeys, signatures, paramsSig)
}

// VerifySigner is a free data retrieval call binding the contract method 0x4f567307.
//
// Solidity: function verifySigner(address claimaddr, address withdrawaddr, bytes[] pubkeys, bytes[] signatures, bytes paramsSig) view returns(bool)
func (_StakingContract *StakingContractCallerSession) VerifySigner(claimaddr common.Address, withdrawaddr common.Address, pubkeys [][]byte, signatures [][]byte, paramsSig []byte) (bool, error) {
	return _StakingContract.Contract.VerifySigner(&_StakingContract.CallOpts, claimaddr, withdrawaddr, pubkeys, signatures, paramsSig)
}
