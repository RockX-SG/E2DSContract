...
// VerifySigner is a free data retrieval call binding the contract method 0x60c67beb.
//
// Solidity: function verifySigner(address account, address claimaddr, address withdrawaddr, bytes[] pubkeys, bytes[] signatures, bytes paramsSig) view returns(bool)
func (_StakingContract *StakingContractCaller) VerifySigner(opts *bind.CallOpts, account common.Address, claimaddr common.Address, withdrawaddr common.Address, pubkeys [][]byte, signatures [][]byte, paramsSig []byte) (bool, error) {
	var out []interface{}
	err := _StakingContract.contract.Call(opts, &out, "verifySigner", account, claimaddr, withdrawaddr, pubkeys, signatures, paramsSig)
...
//
// Solidity: function verifySigner(address account, address claimaddr, address withdrawaddr, bytes[] pubkeys, bytes[] signatures, bytes paramsSig) view returns(bool)
func (_StakingContract *StakingContractSession) VerifySigner(account common.Address, claimaddr common.Address, withdrawaddr common.Address, pubkeys [][]byte, signatures [][]byte, paramsSig []byte) (bool, error) {
	return _StakingContract.Contract.VerifySigner(&_StakingContract.CallOpts, account, claimaddr, withdrawaddr, pubkeys, signatures, paramsSig)
}

// VerifySigner is a free data retrieval call binding the contract method 0x60c67beb.
//
// Solidity: function verifySigner(address account, address claimaddr, address withdrawaddr, bytes[] pubkeys, bytes[] signatures, bytes paramsSig) view returns(bool)
func (_StakingContract *StakingContractCallerSession) VerifySigner(account common.Address, claimaddr common.Address, withdrawaddr common.Address, pubkeys [][]byte, signatures [][]byte, paramsSig []byte) (bool, error) {
	return _StakingContract.Contract.VerifySigner(&_StakingContract.CallOpts, account, claimaddr, withdrawaddr, pubkeys, signatures, paramsSig)
}
